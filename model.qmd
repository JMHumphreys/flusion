...
**Note:** This script requires that both data **Preprocessing** and **data organization** have already been completed with all resulting objects available in the working environment.    
...
#Preprocessing  
load("./data/dstacks_06072023.RData")
```
...
# Next Step: Inspect Model results